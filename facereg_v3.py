...
from utils.helper import visualize, process
import datetime
import numpy as np
...
def initialize_models():
    ...
    fer_model = FacialExpressionRecog(modelPath=r'models/facial_expression_recognition_mobilefacenet_2022july.onnx',
